...
class MaskDecoder(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.pred_obj_scores = pred_obj_scores # DeSAM?
        if self.pred_obj_scores:
            self.obj_score_token = nn.Embedding(1, transformer_dim) # DeSAM?
        self.use_multimask_token_for_obj_ptr = use_multimask_token_for_obj_ptr # DeSAM?
    ...
    def predict_masks(
        ...
        if not self.use_high_res_features:
            ...
            # src: torch.Size([batch, 256, 64, 64]) #image_embed
            # feat_s1: torch.Size([batch, 64, 128, 128]) #high_res_feats part1
            # feat_s0: torch.Size([batch, 32, 256, 256]) #high_res_feats part0
            # upscaled_embedding torch.Size([batch, 32, 256, 256])
